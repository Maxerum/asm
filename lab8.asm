...
reset_require db 0
p equ 19h
reset_str db "Reset has been succesfull!", 10, 13
printStr db "Console has been saved!", 10, 13  
cannot_create_file_str db "Cannot  create file", 10, 13 
key_letter db 2 dup(?)
wrong_args_cmdl db "Wrong command line arguments: the first - filename;the sec arg : 1 - ctrl + p, 2 - ctrl + f, 3 - ctrl + l;"  , '$'
begin_program db "Programm started", '$', 10, 13
resident_str db "Programm is resident now", 10, 13, "ctrl+z - return old interrupts" , '$'
already_exec_str db "Programm is already running.", '$'
endl db 10, 13, '$' 
